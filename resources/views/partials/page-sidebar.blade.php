  ...
  <aside class="hidden pt-24 pb-12 border-r border-sky xl:block">
    <nav class="">
      ...
      @foreach ($siblings as $page)
        <a class="@if (get_permalink() == get_permalink($page->ID)) bg-opacity-100 text-navy @else hover:bg-opacity-100 bg-opacity-0 @endif pl-0 px-6 2xl:pl-0 2xl:px-8 block py-1.5 text-lg bg-sky transition"
