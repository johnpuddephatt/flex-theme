<div class="border-t border-sky relative lg:pt-16">
  <div
    class="<?php echo e($background ?? 'bg-sky'); ?> z-10 px-0 container flex flex-col-reverse rounded-bl-big overflow-hidden items-start mx-auto text-white max-w-7xl md:flex-row">
