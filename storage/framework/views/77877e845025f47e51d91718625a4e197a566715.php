...
<div class="text-center">
  ...
  <div class="overflow-x-auto">
    <div class="text-left grid grid-cols-3 gap-16 container w-[250%] lg:w-full">
  ...
  <a href="/publications/?all&orderby=date&order=DESC"
    class="mt-12 mx-auto lowercase bg-green text-white border-2 text-base border-green inline-block px-8 py-3 font-semibold rounded-xl rounded-tr-none whitespace-nowrap">
    View all
  </a>
</div>
