          ...
          <div class="flex flex-col space-y-8 text-center lg:text-left">
            <a href="<?php echo e(get_permalink($block->ID)); ?>" class="relative">
              <div class="max-w-lg mx-auto">
                <div
                  class="<?php echo e(match ($loop->iteration) {1 => '',2 => 'mt-[8.333%]',3 => 'ml-[8.333%] mt-[8.333%]',4 => 'ml-[8.333%]'}); ?> top-0 absolute -z-10 rounded-tr-medium rounded-bl-medium xl:rounded-tr-big xl:rounded-bl-big bg-sky bg-opacity-40 aspect-square w-10/12">
                </div>
