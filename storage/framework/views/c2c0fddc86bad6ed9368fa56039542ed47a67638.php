    ...
    <nav class="">
      <h2 class="pl-0 2xl:pl-0 px-6 mb-6 text-xl font-semibold 2xl:px-8">
        <a class="pl-[calc((100vw-1280px)/2)] 2xl:pl-[calc((100vw-1536px)/2)] block mx-auto mr-16 w-60"
          href=" <?php echo e($parent->permalink); ?>">
      ...
      <?php $__currentLoopData = $siblings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a class="<?php if(get_permalink() == get_permalink($page->ID)): ?> bg-opacity-100 text-navy <?php else: ?> hover:bg-opacity-30 bg-opacity-0 <?php endif; ?> pl-0 px-6 2xl:pl-0 2xl:px-8 block py-3 text-lg bg-sky transition"
          href="<?php echo e(get_permalink($page->ID)); ?>">
          <span
            class="pl-[calc((100vw-1280px)/2)] 2xl:pl-[calc((100vw-1536px)/2)] block mx-auto mr-4 w-72"><?php echo get_the_title($page->ID); ?></span>
        </a>
